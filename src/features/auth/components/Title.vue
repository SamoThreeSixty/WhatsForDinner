    ...
    <div class="mb-7 space-y-4 md:mb-8">
        <div class="flex items-center gap-3">
            ...
            <div class="space-y-0.5">
                ...
                <p class="text-[0.9rem] text-[var(--green-muted)]">Playful healthy meal planning</p>
            </div>
        </div>

        <h1 class="font-[var(--font-display)] text-[clamp(1.9rem,4vw,3.1rem)] leading-[1.06] text-[var(--green-ink)]">
            Good food starts with what is already in your kitchen.
        </h1>
    </div>
</template>
